...
<div class="container-fluid">
    {{-- <div class="block-header">
        <a href="{{ route('admin.author.create') }}" class="btn btn-primary waves-effect"><i class="material-icons">add</i><span>Add New author</span></a>
    </div> --}}
    <!-- Exportable Table -->
                            ...
                            <tbody>
                                @foreach ($authors as $key => $author)
                                    <tr>
                                        ...
                                        <td>{{ $author->updated_at->toDateString() }}</td>
                                        <td class="text-center">
                                            {{-- <a href="{{ route('admin.author.edit', $author->id) }}" class="btn btn-info waves-effect"><i class="material-icons">edit</i></a> --}}
